...
public class SMSMExtendedPartial extends TrajectorySimilarityCalculator<SemanticTrajectory> {
	...
	public SMSMExtendedPartial(SMSM.SMSM_MoveSemanticParameters moveParams, SMSM.SMSM_StopSemanticParameters stopParams) {
		if(moveParams == null) {
